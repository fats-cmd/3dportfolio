 ...
 * Each card shows project details, technologies used, and links to source code.
 * Features Tilt effect on cards and motion animations for enhanced UX.
 */
 ...
 * @param {Array} props.tags - Array of technology tags used in project
 * @param {string} props.image - Project image URL
 * @param {string} props.source_code_link - GitHub repository URL
 */
const ProjectCard = ({
  index,
  name,
  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        {/* Project Image with GitHub Link */}
